            ...
            >
                        ...
                        <div className="megamenu-wrapper">
                          <div className="row">
                            ...
                            <div className="col-lg-2">
                              <div
                                className={`single-demo ${
                                  pathnames.includes("/home4") ? "active" : ""
                                }`}
                              >
                                <div className="demo-img">
                            ...
                            <div className="col-lg-2">
                              <div
                                className={`single-demo ${
                                  pathnames.includes("/home6") ? "active" : ""
                                }`}
                              >
                                <div className="demo-img">
                            ...
                            <div className="col-lg-2">
                              <div
                                className={`single-demo ${
                                  pathnames.includes("/index10") ? "active" : ""
                                }`}
                              >
                                <div className="demo-img">
                                  <Link
              ...
              pathnames.includes("/home9") ? (
                <ul className="nav header-navbar-rht">
                  ...
                  <li
                    className={`${
                      pathnames.includes("/home7") || "/home9"
                        ? "login-in-fourteen"
                        : "register-btn"
                    }`}
                  >
