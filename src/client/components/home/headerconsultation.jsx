...
import { flag01, flag02, flag03, flag05 } from '../../../admin/components/imagepath'
          ...
          <div className="flag-dropdown">
            ...
            <div className="dropdown-menu">
              <Link to="#" className="dropdown-item">
                <img src={flag01} alt="" height={16} />{" "}
                English
              </Link>
              <Link to="#" className="dropdown-item">
                <img src={flag02} alt="" height={16} />{" "}
                French
              </Link>
              <Link to="#" className="dropdown-item">
                <img src={flag03} alt="" height={16} />{" "}
                Spanish
              </Link>
              <Link to="#" className="dropdown-item">
                <img src={flag05} alt="" height={16} />{" "}
                German
              </Link>
            </div>
          </div>
