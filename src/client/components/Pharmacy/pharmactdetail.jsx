                ...
                <div className="doctor-widget">
                  ...
                  <div className="doc-info-right d-flex align-items-center justify-content-center">
                    <div className="clinic-booking">
                      ...
                      <Link className="apt-btn" to="#" data-bs-toggle="modal" data-bs-target="#voice_call"  onClick={handleShow}>Call Now</Link>
                ...
                <nav className="user-tabs mb-4">
                  <ul className="nav nav-tabs nav-tabs-bottom nav-justified">
                    <li className="nav-item" onClick={(e)=>tabclick(1) }>
                      <Link className={`nav-link ${isoverview ? "active" : ""}`} to="#doc_overview" data-bs-toggle="tab">Overview</Link>
                    </li>
                    <li className="nav-item" onClick={(e)=>setislocation }>
                      <Link className={`nav-link ${islocation ? "active" : ""}`} to="#doc_locations" data-bs-toggle="tab">Locations</Link>
                    </li>
                    <li className="nav-item" onClick={(e)=>setisisreview }>
                      <Link className={`nav-link ${isreview ? "active" : ""}`} to="#doc_reviews" data-bs-toggle="tab">Reviews</Link>
                    </li>
                    <li className="nav-item" onClick={(e)=>setiSbusinesshour }>
                      <Link className={`nav-link ${isbusinesshour ? "active" : ""}`} to="#doc_business_hours" data-bs-toggle="tab">Business Hours</Link>
                    </li>
                  </ul>
                </nav>
                {/* /Tab Menu */}
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="clinic-content">
                            <h4 className="clinic-name"><Link to="#">Medlife Medical</Link></h4>
                            ...
                            <div className="clinic-details mb-0">
                              <h5 className="clinic-direction"> <i className="fas fa-map-marker-alt" /> 96 Red Hawk Road Cyrus, MN 56323  <br /><Link to="#">Get Directions</Link></h5>
                              <ul>
                                <li>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="clinic-content">
                            ...
                            <div className="clinic-details mb-0">
                              <p className="clinic-direction"> <i className="fas fa-map-marker-alt" /> 310 Cambridge Drive New River, AZ 85020  <br /><Link to="#">Get Directions</Link></p>
                              <ul>
                                <li>
                                  <Link to={feature01} data-fancybox="gallery2">
                                    <img src={feature01} alt="Feature Image" />
  ...
  <div className="call-wrapper">
    <div className="call-inner">
      ...
      <div className="call-items">
        ...
        <Link to="/pages/voicecall" className="btn call-item call-start">
