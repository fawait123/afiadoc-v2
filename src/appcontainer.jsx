        ...
        {url === "admin" ? (
          ...
          <div>
            <Switch>
              ...
              <Route path="/cardiohome" exact component={Cardiohome} />
              <Route path="/paediatrichome" exact component={Paediatrichome} />
              ...
              <Route path="/index10" exact component={Home10} />
              <Route path="/home11" exact component={Home11} />
              <Route path="/cosmeticshome" exact component={CosmeticsHome} />
